...
namespace ADMIC.Forms.ContentPages.Region
{
	public partial class RegionPage : BasePage
	{
		HomeDrawerPage RootPage;
		public static bool Changed = false;
		public static List<ADMIC.Data.Models.Region> _regionSer = null;
		ObservableCollection<ADMIC.Data.Models.Region> _itemsList = new ObservableCollection<ADMIC.Data.Models.Region>();
...
*/
        ...
        void MergeLists(List<ADMIC.Data.Models.Region> Mergeregiones)
		{
			...
			App.CurrentApp.RealmInstance.Write(() =>
				{
					...
					{
                    App.CurrentApp.RealmInstance.RemoveRange(App.CurrentApp.RealmInstance.All<ADMIC.Data.Models.Region>().Where(x => x.id_region == _evento.id_region));
					}
		...
		async void TapItem(object sender, System.EventArgs e)
		{
            ...
            if (stack.BindingContext is ADMIC.Data.Models.Region)
			{
                var region = stack.BindingContext as ADMIC.Data.Models.Region;
