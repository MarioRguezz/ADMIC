...
using ADMIC.Forms.ViewCells;
using Xamarin.Forms;

namespace ADMIC.Forms.ContentPages
{
	public partial class ChatPage : BasePage
	{
		...
		void IntiViews()
		{
			...
			_listView.HeightRequest = App.ScreenHeight - 150;
		...
		void CurrentApp_MensajeRecibido(object sender, ChatModel e)
		{
			_items.Add(e);
			ScrollToLast(true);
		}
