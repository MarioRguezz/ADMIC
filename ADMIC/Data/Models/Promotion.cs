...
namespace ADMIC.Data.Models
{
    ...
    public class Promotion : RealmObject
    {
        ...
        public string FechaInicioLabel
        {
            get
            {
                var dateTime = DateTime.Parse(fecha_inicio);
                return "Fecha Inicio: " + dateTime.ToString("dd-MM-yyyy");
            }
        }

        public string FechaFinLabel
        {
            get
            {
                var dateTime = DateTime.Parse(fecha_fin);
                return "Fecha Fin: " + dateTime.ToString("dd-MM-yyyy");
            }
        }
